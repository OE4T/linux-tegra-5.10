...
#define CAPTURE_STATUS_FLAG_CHANNEL_IN_ERROR			(U32_C(1) << 1U)
	 ...
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_PIXEL_MISSING_LE		(U64_C(1) << 27U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_PIXEL_RUNAWAY			(U64_C(1) << 28U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_PIXEL_SPURIOUS		(U64_C(1) << 29U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_PIXEL_LONG_LINE		(U64_C(1) << 30U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_PIXEL_SHORT_LINE		(U64_C(1) << 31U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_EMBED_MISSING_LE		(U64_C(1) << 32U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_EMBED_RUNAWAY			(U64_C(1) << 33U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_EMBED_SPURIOUS		(U64_C(1) << 34U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_EMBED_LONG_LINE		(U64_C(1) << 35U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_EMBED_INFRINGE		(U64_C(1) << 36U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_DTYPE_MISMATCH		(U64_C(1) << 37U)
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_RESERVED_0			(U64_C(1) << 38U)

	/*
	 * CHANSEL PIX_SHORT (TAG 0xD)
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_PIX_SHORT			(U64_C(1) << 39U)

	/*
	 * CHANSEL EMB_SHORT (TAG 0xD) Notification.
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_EMB_SHORT			(U64_C(1) << 40U)

	/* PFSD */
	#define CAPTURE_STATUS_NOTIFY_BIT_PFSD_FAULT				(U64_C(1) << 41U)

	/*
	 * CHANSEL FAULT_FE (TAG 0xA) Notification
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_FAULT_FE			(U64_C(1) << 42U)
	 ...
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_NO_MATCH			(U64_C(1) << 43U)

	/*
	 * CHANSEL COLLISION (TAG 0xC) Notification
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_COLLISION			(U64_C(1) << 44U)

	/*
	 * CHANSEL LOAD_FRAMED (TAG 0xE) Notification
	 */
	#define CAPTURE_STATUS_NOTIFY_BIT_CHANSEL_LOAD_FRAMED			(U64_C(1) << 45U)

	/* ATOMP_PACKER_OVERFLOW   (TAG 0xf) */
	#define CAPTURE_STATUS_NOTIFY_BIT_ATOMP_PACKER_OVERFLOW			(U64_C(1) << 46U)

	/* ATOMP_FRAME_TRUNCATED   (TAG 0x15) Frame not finished */
	#define CAPTURE_STATUS_NOTIFY_BIT_ATOMP_FRAME_TRUNCATED			(U64_C(1) << 47U)
