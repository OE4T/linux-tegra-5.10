...
dtbo-$(BUILD_18x_ENABLE) += tegra194-p2888-0001-p2822-0000-hdr40.dtbo
dtbo-$(BUILD_18x_ENABLE) += tegra194-p2888-0001-p2822-0000-adafruit-sph0645lm4h.dtbo
dtbo-$(BUILD_18x_ENABLE) += tegra194-p2888-0001-p2822-0000-fe-pi-audio-z-v2.dtbo
dtbo-$(BUILD_18x_ENABLE) += tegra194-p2888-0001-p2822-0000-respeaker-4-mic-array.dtbo
