...
{
    /* UserCode{5BFA02E6-7C87-42f5-B947-80CA2D63C39D}:1xBgNfjofw */
    uint32_t i;
    ...
    /* UserCode{5BFA02E6-7C87-42f5-B947-80CA2D63C39D} */
}
...
{
    /* UserCode{2A678EDB-CEC6-4faf-9838-3A1ACF2E708D}:1QqJr2Wj7m */
    int val = sizeof(np->unimac_stat) / sizeof(uint64_t);
    val += (np->num_rx_chan * sizeof(oak_driver_rx_stat) / sizeof(uint64_t));
    val += (np->num_tx_chan * sizeof(oak_driver_tx_stat) / sizeof(uint64_t));
    return (val);
    /* UserCode{2A678EDB-CEC6-4faf-9838-3A1ACF2E708D} */
}
...
{
    /* UserCode{3D4FA67A-E16D-4cdc-A397-0351EC9091C7}:18etN8PAlT */
    int off = 0;
    uint32_t i;
    ...
    return (off);
    /* UserCode{3D4FA67A-E16D-4cdc-A397-0351EC9091C7} */
}
