...
#if 0
static int	oak_ethtool_get_settings(struct net_device* dev, struct ethtool_cmd *ecmd);
#else
static int	oak_ethtool_get_link_ksettings(struct net_device *dev, struct ethtool_link_ksettings *cmd) ;
#endif
