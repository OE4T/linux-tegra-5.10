...
static struct index_reg_8 i2c_address_trans_hawk[] = {
	/* HAWK1 0x10 -> 0x30, 0x18 -> 0x31 */
	{0x94, 0x0042, 0x60},
	{0x94, 0x0043, 0x20},
	{0x94, 0x0044, 0x62},
	{0x94, 0x0045, 0x30},
	/* HAWK2 0x10 -> 0x32, 0x18 -> 0x33 */
	{0x96, 0x0042, 0x64},
	{0x96, 0x0043, 0x20},
	{0x96, 0x0044, 0x66},
	{0x96, 0x0045, 0x30},
	/* HAWK3 0x10 -> 0x34, 0x18 -> 0x35 */
	{0x98, 0x0042, 0x68},
	{0x98, 0x0043, 0x20},
	{0x98, 0x0044, 0x6a},
	{0x98, 0x0045, 0x30},
	/* HAWK4 0x10 -> 0x36, 0x18 -> 0x37 */
	{0x9a, 0x0042, 0x6c},
	{0x9a, 0x0043, 0x20},
	{0x9a, 0x0044, 0x6e},
	{0x9a, 0x0045, 0x30},
...
/* TODO: Add EEPROM addr trans for Hawk3 & Hawk4 */
...
static struct index_reg_8 ar0234_Hawk_Dser_Ser[] = {
	...
	{0x94, 0x02DB, 0x08},
	{0x94, 0x02Dc, 0x04},
	{0x94, 0x02De, 0x08}, // MFP8 for FSIN

	{0x96, 0x02D9, 0x04},
	{0x96, 0x02DB, 0x08},
	{0x96, 0x02Dc, 0x04},
	{0x96, 0x02De, 0x08}, // MFP8 for FSIN
