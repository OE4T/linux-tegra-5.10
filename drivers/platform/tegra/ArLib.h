 ...
 */
typedef uint32_t E2E_returntype_t;
 ...
 *
 */
E2E_returntype_t E2E_P05Protect(const E2E_P05ConfigType* ConfigPtr, E2E_P05ProtectStateType* StatePtr, uint8_t* DataPtr, uint16_t Length);
 ...
 *  @return Error code (E2E_E_INPUTERR_NULL || E2E_E_INPUTERR_WRONG || E2E_E_OK).
 */
E2E_returntype_t E2E_P05Check(const E2E_P05ConfigType* ConfigPtr, E2E_P05CheckStateType* StatePtr, const uint8_t* DataPtr, uint16_t Length);
